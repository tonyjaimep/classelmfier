...
var $author$project$Main$WeightValueChanged = F2(
	function (a, b) {
		return {$: 'WeightValueChanged', a: a, b: b};
	});
...
var $author$project$Main$weightEditor = F2(
	function (isReadonly, weight) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('weight-editor')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromFloat(weight.value)),
							$elm$html$Html$Events$onInput(
							$author$project$Main$WeightValueChanged(weight.id))
						]),
					_List_Nil)
				]));
	});
var $author$project$Main$controls = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('weight-controls')
			]),
		A2(
			$elm$core$List$map,
			$author$project$Main$weightEditor(model.isTraining),
			model.weights));
};
var $author$project$Main$CanvasClicked = function (a) {
	return {$: 'CanvasClicked', a: a};
};
...
var $author$project$Main$canvasBackground = $avh4$elm_color$Color$black;
...
var $author$project$Main$canvasGraphLines = function (dimensions) {
	return A2(
		$joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
			[
				$joakin$elm_canvas$Canvas$Settings$stroke(
				A4($avh4$elm_color$Color$rgba, 1, 1, 1, 0.7)),
				$joakin$elm_canvas$Canvas$Settings$Line$lineWidth(0),
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(dimensions.width / 2, dimensions.height / 2),
				_List_fromArray(
					[
						$joakin$elm_canvas$Canvas$lineTo(
						_Utils_Tuple2(dimensions.width / 2, dimensions.height))
					])),
				A2(
				$joakin$elm_canvas$Canvas$path,
				_Utils_Tuple2(dimensions.width / 2, dimensions.height / 2),
				_List_fromArray(
					[
						$joakin$elm_canvas$Canvas$lineTo(
						_Utils_Tuple2(dimensions.width / 2, 0))
					])),
				A2(
				$joakin$elm_canvas$Canvas$path,
				_Utils_Tuple2(dimensions.width / 2, dimensions.height / 2),
				_List_fromArray(
					[
						$joakin$elm_canvas$Canvas$lineTo(
						_Utils_Tuple2(0, dimensions.height / 2))
					])),
				A2(
				$joakin$elm_canvas$Canvas$path,
				_Utils_Tuple2(dimensions.width / 2, dimensions.height / 2),
				_List_fromArray(
					[
						$joakin$elm_canvas$Canvas$lineTo(
						_Utils_Tuple2(dimensions.width, dimensions.height / 2))
					]))
			]));
};
...
var $author$project$Main$pointSize = 3.0;
var $author$project$Main$toCanvasRelative = F2(
	function (graphDimension, value) {
		return (graphDimension / 2) + value;
	});
var $author$project$Main$toCanvasX = F2(
	function (graphDimension, value) {
		return A2($author$project$Main$toCanvasRelative, graphDimension, value);
	});
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Main$toCanvasY = F2(
	function (graphDimension, value) {
		return A2($author$project$Main$toCanvasRelative, graphDimension, (-1) * value);
	});
var $author$project$Main$inputToShape = F2(
	function (dimensions, input) {
		return A2(
			$joakin$elm_canvas$Canvas$circle,
			_Utils_Tuple2(
				A2($author$project$Main$toCanvasX, dimensions.width, input.x1),
				A2($author$project$Main$toCanvasY, dimensions.height, input.x2)),
			$author$project$Main$pointSize);
	});
var $author$project$Main$colorBetween = F3(
	function (from, to, percent) {
		return {b: from.b + (percent * (to.b - from.b)), g: from.g + (percent * (to.g - from.g)), r: from.r + (percent * (to.r - from.r))};
	});
var $author$project$Main$disabledOutputRgb = {b: 1.0, g: 0.2, r: 0.3};
var $author$project$Main$enabledOutputRgb = {b: 0.3, g: 0.8, r: 1.0};
var $avh4$elm_color$Color$rgb = F3(
	function (r, g, b) {
		return A4($avh4$elm_color$Color$RgbaSpace, r, g, b, 1.0);
	});
var $author$project$Main$rgbToColor = function (rgb) {
	return A3($avh4$elm_color$Color$rgb, rgb.r, rgb.g, rgb.b);
};
var $author$project$Main$networkOutputColor = function (output) {
	return $author$project$Main$rgbToColor(
		A3($author$project$Main$colorBetween, $author$project$Main$disabledOutputRgb, $author$project$Main$enabledOutputRgb, output));
};
var $author$project$Main$graphPoints = F3(
	function (network, dimensions, dataPoints) {
		return A2(
			$joakin$elm_canvas$Canvas$group,
			_List_fromArray(
				[
					$joakin$elm_canvas$Canvas$Settings$Line$lineWidth($author$project$Main$pointSize / 2)
				]),
			A2(
				$elm$core$List$map,
				function (dataPoint) {
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$networkOutputColor(
									network(dataPoint))),
								$joakin$elm_canvas$Canvas$Settings$stroke(
								$author$project$Main$networkOutputColor(dataPoint.expectedOutput))
							]),
						_List_fromArray(
							[
								A2($author$project$Main$inputToShape, dimensions, dataPoint)
							]));
				},
				dataPoints));
	});
...
var $author$project$Main$biasValue = function (weights) {
	var _v0 = $elm$core$List$head(
		$elm$core$List$reverse(weights));
	if (_v0.$ === 'Just') {
		var weight = _v0.a;
		return weight.value;
	} else {
...
var $author$project$Main$firstWeightValue = function (weights) {
	var _v0 = $elm$core$List$head(weights);
	if (_v0.$ === 'Just') {
		var weight = _v0.a;
		return weight.value;
	} else {
...
var $author$project$Main$secondWeight = function (weights) {
	var _v0 = $elm$core$List$tail(weights);
	if (_v0.$ === 'Just') {
		var weightsTail = _v0.a;
		var _v1 = $elm$core$List$head(weightsTail);
		if (_v1.$ === 'Just') {
			var weight = _v1.a;
			return weight.value;
		} else {
...
var $author$project$Main$calculateY = F2(
	function (x, weights) {
		var dividedBySecondWeight = function (value) {
			return value / $author$project$Main$secondWeight(weights);
		};
		return (-1) * ((dividedBySecondWeight(
			$author$project$Main$firstWeightValue(weights)) * x) + dividedBySecondWeight(
			$author$project$Main$biasValue(weights)));
	});
var $avh4$elm_color$Color$red = A4($avh4$elm_color$Color$RgbaSpace, 204 / 255, 0 / 255, 0 / 255, 1.0);
var $author$project$Main$toGraphRelative = F2(
	function (graphDimension, value) {
		var zeroPosition = graphDimension / 2;
		return value - zeroPosition;
	});
var $author$project$Main$toGraphX = $author$project$Main$toGraphRelative;
var $author$project$Main$modelLine = F2(
	function (dimensions, weights) {
		return A2(
			$joakin$elm_canvas$Canvas$shapes,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
						0,
						A2(
							$author$project$Main$toCanvasY,
							dimensions.height,
							A2(
								$author$project$Main$calculateY,
								A2($author$project$Main$toGraphX, dimensions.width, 0),
								weights))),
					_List_fromArray(
						[
							$joakin$elm_canvas$Canvas$lineTo(
							_Utils_Tuple2(
								...
								A2(
									...
									A2(
										$author$project$Main$calculateY,
										A2($author$project$Main$toGraphRelative, dimensions.width, dimensions.width),
										weights))))
						]))
				]));
	});
...
var $author$project$Main$graphCanvasContent = F2(
	function (model, network) {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$joakin$elm_canvas$Canvas$Settings$fill($author$project$Main$canvasBackground)
					]),
				_List_fromArray(
					[
						A3(
				...
				$author$project$Main$canvasGraphLines(model.graphDimensions),
				A3($author$project$Main$graphPoints, network, model.graphDimensions, model.dataPoints),
				A2($author$project$Main$modelLine, model.graphDimensions, model.weights)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_Utils_Tuple2(model.graphDimensions.width, model.graphDimensions.height),
					_List_fromArray(
						[
							$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onClick(
							function (event) {
								return $author$project$Main$CanvasClicked(event.offsetPos);
							})
						]),
					A2($author$project$Main$graphCanvasContent, model, network))
				]));
	});
var $author$project$Main$weightValues = function (weights) {
	return A2(
		$elm$core$List$map,
		function ($) {
			return $.value;
...
var $author$project$Main$neuronSigma = F2(
	function (model, dataPoint) {
		return A3(
			$elm$core$List$foldl,
			$elm$core$Basics$add,
			0,
			A3(
				...
				$author$project$Main$weightValues(model.weights)));
	});
var $author$project$Main$networkForModel = F2(
	function (model, input) {
		return model.activation(
			A2($author$project$Main$neuronSigma, model, input));
	});
var $elm$html$Html$aside = _VirtualDom_node('aside');
var $author$project$Main$outputColorCircleHtml = F2(
	function (output, expectedOutput) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('network-output-circle'),
					A2(
					$elm$html$Html$Attributes$style,
					'background-color',
					$avh4$elm_color$Color$toCssString(
						$author$project$Main$networkOutputColor(output))),
					A2(
					$elm$html$Html$Attributes$style,
					'border-color',
					$avh4$elm_color$Color$toCssString(
						$author$project$Main$networkOutputColor(expectedOutput)))
				]),
			_List_Nil);
	});
var $author$project$Main$inputDetail = F2(
	function (network, dataPoint) {
		var output = network(dataPoint);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('data-point-detail')
				]),
			_List_fromArray(
				[
					A2($author$project$Main$outputColorCircleHtml, output, dataPoint.expectedOutput),
					$elm$html$Html$text('('),
					$elm$html$Html$text(
					$elm$core$String$fromFloat(dataPoint.x1)),
					$elm$html$Html$text(','),
					$elm$html$Html$text(
					$elm$core$String$fromFloat(dataPoint.x2)),
					$elm$html$Html$text(')')
				]));
	});
var $author$project$Main$dataPointListing = F2(
	function (dataPoints, network) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('data-point-listing')
				]),
			A2(
				$elm$core$List$map,
				$author$project$Main$inputDetail(network),
				dataPoints));
	});
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Main$epochCounter = function (epochs) {
	return A2(
		$elm$html$Html$span,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('Epochs: '),
				$elm$html$Html$text(
				$elm$core$String$fromInt(epochs))
			]));
};
var $author$project$Main$DataPointTypeChanged = function (a) {
	return {$: 'DataPointTypeChanged', a: a};
};
...
var $author$project$Main$expectedOutputControl = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('expected-output-control')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('expected-output-label')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Expect'),
						A2($author$project$Main$outputColorCircleHtml, model.nextExpectedOutput, model.nextExpectedOutput),
						$elm$html$Html$text('('),
						$elm$html$Html$text(
						$elm$core$String$fromFloat(model.nextExpectedOutput)),
						$elm$html$Html$text(')')
					])),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput(
						function (v) {
							return $author$project$Main$DataPointTypeChanged(
								A2(
...
var $author$project$Main$DataPointsCleared = {$: 'DataPointsCleared'};
...
var $author$project$Main$inputClearingButton = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$Main$DataPointsCleared)
		]),
	_List_fromArray(
		[
			$elm$html$Html$text('Clear data points')
		]));
var $author$project$Main$inputControls = function (dataPoints) {
	return ($elm$core$List$length(dataPoints) > 0) ? $author$project$Main$inputClearingButton : $elm$html$Html$text('');
};
var $author$project$Main$TrainingStarted = {$: 'TrainingStarted'};
var $author$project$Main$TrainingStopped = {$: 'TrainingStopped'};
var $author$project$Main$startTrainingButton = function (isTraining) {
	var textString = isTraining ? 'Stop training' : 'Start training';
	var message = isTraining ? $author$project$Main$TrainingStopped : $author$project$Main$TrainingStarted;
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
...
var $author$project$Main$sidebar = F2(
	function (model, network) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Main$epochCounter(model.epochs),
					$author$project$Main$expectedOutputControl(model),
					$author$project$Main$startTrainingButton(model.isTraining),
					$author$project$Main$inputControls(model.dataPoints),
					A2($author$project$Main$dataPointListing, model.dataPoints, network)
				]));
	});
var $author$project$Main$view = function (model) {
	var network = $author$project$Main$networkForModel(model);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('network-data-container')
					]),
				_List_fromArray(
					[
						A2($author$project$Main$graph, model, network),
						A2($author$project$Main$sidebar, model, network)
					])),
				$author$project$Main$controls(model)
			]));
};
var $author$project$Main$documentView = function (model) {
	return {
...
var $author$project$Main$stepActivation = function (x) {
	return (x > 0) ? 1 : 0;
};
var $author$project$Main$initialModel = {
	activation: $author$project$Main$stepActivation,
	dataPoints: _List_Nil,
	epochs: 0,
	graphDimensions: {height: $author$project$Main$canvasSize, width: $author$project$Main$canvasSize},
	isTraining: false,
	nextExpectedOutput: 1,
	weights: _List_fromArray(
		[
			{id: 'w1', value: 1.0},
			{id: 'w2', value: 1.0},
			{id: 'bias', value: 1.0}
...
var $author$project$Main$WeightValueSet = F2(
	function (a, b) {
		return {$: 'WeightValueSet', a: a, b: b};
	});
...
var $author$project$Main$randomWeightValueGenerator = A2($elm$random$Random$float, (-0.5) * $author$project$Main$canvasSize, 0.5 * $author$project$Main$canvasSize);
var $author$project$Main$randomWeightsTasks = function (model) {
	var taskForWeight = function (weight) {
		return A2(
			$elm$random$Random$generate,
			$author$project$Main$WeightValueSet(weight.id),
			$author$project$Main$randomWeightValueGenerator);
	};
	return A2($elm$core$List$map, taskForWeight, model.weights);
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$initialModel,
		$elm$core$Platform$Cmd$batch(
			$author$project$Main$randomWeightsTasks($author$project$Main$initialModel)));
};
var $author$project$Main$TrainingTick = {$: 'TrainingTick'};
...
var $author$project$Main$subscriptions = function (model) {
	return model.isTraining ? A2(
		$elm$time$Time$every,
		100,
		function (_v0) {
			return $author$project$Main$TrainingTick;
		}) : $elm$core$Platform$Sub$none;
};
var $author$project$Main$DataPointAdded = function (a) {
	return {$: 'DataPointAdded', a: a};
};
var $author$project$Main$Epoch = {$: 'Epoch'};
var $author$project$Main$epochLimit = 500;
var $author$project$Main$errorThreshold = 0;
...
var $author$project$Main$learningRate = 0.4;
var $author$project$Main$adjustedWeight = F3(
	function (error, weight, dataDimension) {
		return _Utils_update(
			weight,
			{value: weight.value + ((dataDimension * error) * $author$project$Main$learningRate)});
	});
var $author$project$Main$dataPointVector = function (dataPoint) {
	return _List_fromArray(
		[dataPoint.x1, dataPoint.x2, 1]);
};
var $author$project$Main$errorForDataPoint = F2(
	function (network, dataPoint) {
		return dataPoint.expectedOutput - network(dataPoint);
	});
var $author$project$Main$adjustedWeights = F2(
	function (dataPoint, model) {
		var network = $author$project$Main$networkForModel(model);
		return A3(
			$elm$core$List$map2,
			$author$project$Main$adjustedWeight(
				A2($author$project$Main$errorForDataPoint, network, dataPoint)),
			model.weights,
			$author$project$Main$dataPointVector(dataPoint));
	});
var $author$project$Main$modelWithAdjustedWeights = function (model) {
	var adjustedForDataPoint = F2(
		function (dataPoint, model_) {
			return _Utils_update(
				model_,
				{
					weights: A2($author$project$Main$adjustedWeights, dataPoint, model_)
				});
		});
	return A3($elm$core$List$foldl, adjustedForDataPoint, model, model.dataPoints);
};
var $elm$core$Basics$neq = _Utils_notEqual;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$setWeightValue = F3(
	function (weightId, weightValue, weights) {
		var replaceWeightValue = function (weight) {
			return _Utils_eq(weight.id, weightId) ? _Utils_update(
				weight,
				{value: weightValue}) : weight;
		};
		return A2($elm$core$List$map, replaceWeightValue, weights);
	});
var $author$project$Main$toGraphY = F2(
	function (graphHeight, y) {
		return (-1) * A2($author$project$Main$toGraphRelative, graphHeight, y);
	});
var $author$project$Main$absoluteErrorForDataPoint = F2(
	function (network, dataPoint) {
		return $elm$core$Basics$abs(
			A2($author$project$Main$errorForDataPoint, network, dataPoint));
	});
var $author$project$Main$totalAbsoluteError = function (model) {
	var network = $author$project$Main$networkForModel(model);
	return A3(
		$elm$core$List$foldl,
		$elm$core$Basics$add,
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$absoluteErrorForDataPoint(network),
			model.dataPoints));
};
				...
				case 'WeightValueSet':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								weights: A3($author$project$Main$setWeightValue, id, value, model.weights)
							}),
						$elm$core$Platform$Cmd$none);
				case 'WeightValueChanged':
					var id = msg.a;
					var valueAsString = msg.b;
					var parsedValue = function () {
						var _v1 = $elm$core$String$toFloat(valueAsString);
						if (_v1.$ === 'Just') {
							var value = _v1.a;
							return value;
						} else {
					...
					var $temp$msg = A2($author$project$Main$WeightValueSet, id, parsedValue),
						$temp$model = model;
					msg = $temp$msg;
					model = $temp$model;
					continue update;
						...
						_Utils_update(
							model,
							{
								dataPoints: A2(
									...
									function (input) {
										return !_Utils_eq(input.id, inputId);
									},
									model.dataPoints)
							}),
						$elm$core$Platform$Cmd$none);
				case 'DataPointsCleared':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{dataPoints: _List_Nil}),
						$elm$core$Platform$Cmd$none);
				case 'DataPointTypeChanged':
					var nextExpectedOutput = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{nextExpectedOutput: nextExpectedOutput}),
						$elm$core$Platform$Cmd$none);
				case 'CanvasClicked':
					var _v2 = msg.a;
					var x = _v2.a;
					var y = _v2.b;
					var $temp$msg = $author$project$Main$DataPointAdded(
						{
							expectedOutput: model.nextExpectedOutput,
							id: 'algo',
							x1: A2($author$project$Main$toGraphX, model.graphDimensions.width, x),
							x2: A2($author$project$Main$toGraphY, model.graphDimensions.height, y)
						}),
						$temp$model = model;
					msg = $temp$msg;
					model = $temp$model;
					continue update;
				case 'Epoch':
					var adjusted = $author$project$Main$modelWithAdjustedWeights(model);
					return _Utils_Tuple2(
						_Utils_update(
							adjusted,
							{epochs: adjusted.epochs + 1}),
						$elm$core$Platform$Cmd$none);
				case 'TrainingTick':
					var shouldContinueTraining = (_Utils_cmp(model.epochs, $author$project$Main$epochLimit) < 0) && (_Utils_cmp(
						$author$project$Main$totalAbsoluteError(model),
						$author$project$Main$errorThreshold) > 0);
					if (shouldContinueTraining) {
						var $temp$msg = $author$project$Main$Epoch,
							$temp$model = model;
						msg = $temp$msg;
						model = $temp$model;
						continue update;
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$documentView});
